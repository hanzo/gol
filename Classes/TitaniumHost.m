...
- (void)loadModuleNamed:(NSString*)thisModuleName
{
	...
	//NSLog(@"[DEBUG] loading module %@, class name = %@",thisModuleName,thisModuleClassName); //@@@TH
...
- (void) startModules
{
	appProperties = [NSDictionary dictionaryWithContentsOfFile:[appResourcesPath stringByAppendingPathComponent:@"App.plist"]]; //@@@TH
	...
	//NSLog(@"[DEBUG] Application base url = %@, appid = %@",appBaseUrl, appID); //@@@TH
